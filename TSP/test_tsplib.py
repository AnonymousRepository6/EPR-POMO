...
from TSPModel import TSPModel, Att_Local_policy  #适用于POMO、Omni-pomo
# from TSPModel_ours import TSPModel #适用于Sym-pomo
...
class TSPLib_Tester:
    ...
    def __init__(self, config):
        ...
        self.tsplib_path = '/home/lining/CVRP/EPR-master/TSP/TSPLib'
        self.repeat_times = 1
