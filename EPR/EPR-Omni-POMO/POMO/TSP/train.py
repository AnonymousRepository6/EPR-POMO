...
trainer_params = {
    ...
    'model_load': {
        ...
        'path': '/home/lining/CVRP/Omni-VRP-main-EPR/POMO/TSP/result/20250605_120951_train_tsp',  # directory path of pre-trained model and log files saved.
        'epoch': 150000,  # epoch version of pre-trained model to laod.
    },
...
meta_params = {
    ...
    'L': 0,  # bootstrap steps
    'meta_batch_size': 8,  # will be divided by 2 if problem_size >= 150
